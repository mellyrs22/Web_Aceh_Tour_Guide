...
<li id="menu-item-121" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-96 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-97"><a href="blog.php">Blogs</a></li>
		...
		<?php 
		$result = mysql_query("SELECT id_wisata, nama_wisata, gambar, SUBSTRING(  `keterangan` , 1, 350 ) FROM wisata ORDER BY id_wisata DESC LIMIT 0 , 4");
	...
	<nav class="pagination"><span class='page-numbers current'>1</span>
			...
			<a class="next page-numbers" href="blog2.php"></a>
	</nav>
</div>
...
<?php 
		$result = mysql_query("SELECT * FROM wisata LIMIT 2 , 4");
		while ($row = mysql_fetch_array($result)) {
		?>
<article class="post-112 post type-post status-publish format-standard hentry category-guides tag-amet tag-dolor tag-lorem post clearfix">
		<div class="post-featured-image">
		<div class="featured-image">
			<a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>"><img width="440" height="330" src="wp-content/uploads/2012/11/<?php echo $row[4] ?>" class="attachment-preview wp-post-image" alt="Mon-Ceunong-Indrapuri-piasan-com3.jpg" /></a>
		</div>
	</div>
	<div class="post-content">
