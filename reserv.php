...
<div class="row">
			<div class="row"><div class="eightcol column"><div class="section-title"><h1>Input Reservation</h1></div><br>
			<form action="aksi_reserv.php" method="POST">	
		<table border = 0 width="472" height="203"> <tr>
