		...
		<header class="container site-header">
			...
			<div class="row supheader">
				...
				<div class="social-links">
					<a class="facebook" href="#"  title="Facebook"></a><a class="twitter" href="#" title="Twitter"></a><a class="Login" href="login.php" title="Login"></a>				</div>
				<!-- social links -->
		...
		?>
			<li>
				...
				<a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>">
					<img width="824" height="480" src="Admin/Uploads/<?php echo $row[4] ?>" class="attachment-large wp-post-image" />
				</a>
...
<?php 
		$result = mysql_query("SELECT * FROM wisata ORDER BY id_wisata DESC LIMIT 4 , 3");
		while ($row = mysql_fetch_array($result)) {
		?>
			...
			<div class="tour-thumb">
				...
				<div class="tour-caption">
					<h5 class="tour-title"><a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>" ><?php echo $row[1] ?></a></h5>
									<div class="tour-meta">
											<div class="tour-destination"><div class="colored-icon icon-2"></div><?php echo $row[2] ?></a></div>
	...
	<?php 
		$result1 = mysql_query("SELECT * FROM wisata ORDER BY id_wisata DESC LIMIT 1 , 1");
...
<div class="column threecol last">
	<div class="tour-thumb-container">
		<div class="tour-thumb-container">
		<div class="tour-thumb">
			<a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>"><img width="440" height="330" src="Admin/Uploads/<?php echo $row[4] ?>" alt="air.jpg" /></a>
			<div class="tour-caption">
				<h5 class="tour-title"><a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>" ><?php echo $row[1] ?></a></h5>
								<div class="tour-meta">
										<div class="tour-destination"><div class="colored-icon icon-2"></div><a href="destinations/philippines.html" rel="tag"><?php echo $row[2] ?></a></div>
															<div class="tour-duration"><?php echo $row[3] ?></div>
									</div>
							</div>			
		</div>
		...
		for($j=1; $j<=$kolom; $j++){
			if($j == 3){
				...
				<div class="column gallery-item fourcol last">
					<div class="featured-image">
						<a href="Admin/Uploads/<?php echo $row[2]; ?>" class="colorbox " data-group="gallery-109" title="">
							<img width="440" height="330" src="Admin/Uploads/<?php echo $row[2]; ?>" class="attachment-preview wp-post-image" />		</a>
