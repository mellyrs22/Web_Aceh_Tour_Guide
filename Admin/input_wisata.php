...
<font color="GREEN" face="Kristen ITC" size="4" > >> &nbsp &nbsp Input Tour ! &nbsp &nbsp<<</font>
</marquee></strong><br><br><br>
<form action="../Admin/aksi_wisata.php" method="POST" enctype="multipart/form-data">	
  ...
  <tr>
    ...
    <th width="161" ><div align="left"><strong>
      <input type="text" id="nama" name="nama" value="" placeholder="Nama Wisata" />
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap"><strong>Destinasi</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="Destinasi" name="Destinasi" value=""  placeholder="Destinasi"/>
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap"><strong>Durasi</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="Durasi"  name="Durasi" value="" placeholder="Durasi"  />
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap" ><strong>Keterangan</strong></td>
    <th width="161"><div align="left"><strong>
      <textarea name="Keterangan" id="Keterangan" cols=40 rows=5 placeholder="Keterangan"></textarea>
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap" ><strong>Gambar</strong></td>
    <th width="161"><div align="left"><strong>
	 <input type="file" id="Gambar"  name="Gambar" value="" placeholder="Gambar"  />
    </strong></div></th>
  </tr>
