...
<?php
 error_reporting(E_ALL ^ E_DEPRECATED);
	...
	$limit = 1;
	$query = new CnnNav($limit,'galeri','*','id_galeri');
...
<head>
	...
	<title>Gallery Report | TourAceh</title>	
...
<font color="GREEN" face="Kristen ITC" size="4" > >> &nbsp &nbsp Data Gallery Photos &nbsp &nbsp<<</font>
...
<thead align=right>
        <th width="144"><label for="tcari"></label>
          <div align="right">
            ...
            &nbsp
             <a href="../Admin/report5.php?offset=0class="active""><input type="submit" name="button" id="button" value="All Data" class="btn-info btn style12" /></a>
			&nbsp
			<a href="../Admin/input_galeri.php"> <input type="button" name="button" id="button" value="Input Data" class="btn-info btn style12" /></a>
     ...
     <table width="808" height="67" align="center">
		...
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Id Gallery</strong></b></div></th>
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Nama</strong></b></div></th>
        <th bgcolor="#CCCCCC"><div align="center"><b><strong>Foto</strong></b></div></th>
...
<?php 
	...
	$nomor = 1;
	  ...
	  if(isset($_POST['button'])){
		$result=mysql_query("SELECT * FROM galeri where nama LIKE '%".$_POST['cari']."%'");
		}else{
...
?>
	<tbody>
	 <tr>
				...
				<td valign="top"><CENTER>
				  <span class="nowrap"><?php echo $row[0] ?></span>
				</center></td>
				<td valign="top" class="nowrap"><?php echo $row[1] ?></td>
				<td valign="top" class="nowrap"><img src="../Admin/Uploads/<?php echo $row[2] ?>" alt="" /></td>
				<td width="81"><div align="center"><center>
				  <strong><a href="<?php echo "action_delete_galeri.php?id_galeri=" . $row [0]; ?>" onClick="return confirm ('Apakah anda yakin ingin menghapus data ini ?')"><span class="nowrap">Delete</span></a></strong>
				  </center> 
				  </div>
			    <td width="48"><div align="center"><center>
				    <strong><a href="<?php echo "edit_galeri.php?id_galeri=".$row [0];?>class="btn="btn" btn-mini="btn-mini"><span class="nowrap">Edit</span></a></strong>
				    </center> 
			      </div>
		        </td>       
         </tr>
