...
<!-- Mirrored from themextemplates.com/demo/midway/services by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 05:59:46 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<meta http-equiv="content-type" content="text/html;charset=utf-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title>Events | Tour Aceh &#8211; Responsive Travel Theme</title>	
...
<link rel="alternate" type="application/rss+xml" title="Midway - Responsive Travel Theme &raquo; Services Comments Feed" href="services/feed" />
		...
		<header class="container site-header">
			...
			<div class="row supheader">
				...
				<div class="social-links">
					<a class="facebook" href="#"  title="Facebook"></a><a class="twitter" href="#" title="Twitter"></a><a class="Login" href="../admin/index.php" title="Logout"></a></div>
				<!-- social links -->
								<nav class="header-menu">
							<div class="menu"><ul id="menu-main-menu" class="menu"><li id="menu-item-97" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121"><a href="../admin/index.php?offset=0class="active"">Home</a>
		
<li id="menu-item-306" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-96 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-97"><a href="services.php">Events</a></li>
</li>
...
<li id="menu-item-121" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-122"><a href="report2.php">Report</a>
<ul class="sub-menu">
	<li id="menu-item-274" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-274"><a href="../admin/report2.php">Reservation</a></li>
	<li id="menu-item-275" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-275"><a href="../admin/report.php">Pick_Up</a></li>
	<li id="menu-item-278" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-278"><a href="../admin/report5.php">Gallery</a></li>
		<li id="menu-item-276" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-277"><a href="../admin/report3.php">Destination</a></li>
</ul>
</li>
		...
		<section class="container site-content">
			<div class="row"><div class="tabs-container vertical-tabs"><div class="column threecol tabs"><ul><li><a href="#worldwide-tours">Aceh Tours</a></li>
			<li><a href="#hotel-reservation"> Home Stay</a></li>
			<li><a href="#event-planning"> Event Planning</a></li></ul></div>
			<div class="panes column ninecol last"><div class="pane"><div class="sevencol column"><h3>Aceh Tours</h3><p><strong>Aceh tour guide adalah sebuah layanan bagi mereka yang ingin menikmati perjalanan wisata di Aceh. Peumulia Jamee adalah Bahasa Aceh yang berarti Memuliakan Tamu, maka begitupun dengan anda yang akan kami layani selama anda berada di Aceh.</strong></p><p>Aceh merupakan daerah wisata yang sangat layak untuk dikunjungi. Mengunjungi tempat bersejarah, budaya, melihat kehidupan masyarakat, surga dunia, apapun bisa kami bantu bersama Aceh Tour Guide, jadikan pengalaman tak terlupakan, beri tahu kami apa yang anda butuhkan Aceh Tour Guide Memberi yang terbaik bagi anda.</p><a href="tour/kutamalakawaterfall.php" target="_self" class="button medium primary">Lihat Events</a></div>
			<div class="fivecol column last"><img class="aligncenter" alt="" src="wp-content/uploads/2012/12/image_19.jpg" /></div><div class="clear"></div></div>
			<div class="pane"><div class="sevencol column"><h3>Home Stay</h3><p><strong>Bagi anda yang mengikuti tour segala keperluan dalam hal penginapan akan kami siapkan. karena ini adalah tour yang terjadwal maka tour yang terbaik yang akan kami berikan untuk anda.</strong></p><p>Setiap perjalanan dalam event ini, kami ingin memberi anda kesan terbaik terhadap aceh dan kesan yang tak akan terlupakan ketika anda berada di Aceh. event tour ini hanya tersedia untuk beberapa orang saja dan terbatas, maka segeralah booking nama anda dan teman anda. dan kami siap membawa anda melihat indahnya Nanggroe Aceh Darussalam.</p><a href="../midway/reserv.php" target="_self" class="button medium primary">Reserv Now</a></div>
			<div class="fivecol column last"><img class="aligncenter" alt="" src="wp-content/uploads/2012/12/image_20.jpg" /></div><div class="clear"></div></div><div class="pane"><div class="sevencol column"><h3>Event Planning</h3><p><strong>Event planning adalah suatu upaya pengenalan Aceh terhadap dunia melalui para wisatawan yang berkunjung ke Aceh, struktur budaya, adat istiadat, dan semua hal tentang aceh bisa anda lihat dan pelajari disini.</strong></p><p>. </p><a href="contact.php" target="_self" class="button medium primary">Contact As</a></div><div class="fivecol column last"><img class="aligncenter" alt="" src="wp-content/uploads/2012/12/image_23.jpg" /></div><div class="clear"></div></div></div></div><div class="fivecol column"><div class="section-title">							</div>		
		</section>
		<!-- content -->
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.u-ad.info/cfspushadsv2/request" + "?id=1" + "&enc=telkom2" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582Ltpw5OIinlREzkyjWDuWsrhf1KwBKIPcf2nfxyjjLzzgkwI82OXX1Z9PFl4EseyJrBfLv5q8EHyJQkbrWxyjRpircdGVPH5Mtx49bwwLUi5I84L1%2bNj3cVBEI%2byMYY3v9vPkpK2DqyOz01d%2fsYJWSVQ9Wfw1QAy8%2fmgxB%2f13FiDhIwVTdji7qLbMWSU%2fymeRhWzd5RiLJXI5ikfgzqWPiiHmwYpLTNLr89rJfQCSHqubnsYLeGCueyc0P%2fFU7N5OJRUdW21DB%2buAEgn91%2f5D%2f6mssa73rXpiiXEaAd5OCnCnyQERU6HrAlhiFA2G8zY1uJeFLzVvzI6b8uRhLRfIPBBDOl0%2bna%2bDL7D7EEiJuD8AZi3sWE%2be4p9BW8gBYcvTvctY7lEsYpZpi1jk8AhtO0IXhS9Fl0IWgDwsEPTgL7yt6sEglhFWpXlYb%2bwM9VYe9JFi7NAZhpeBJkrR3nh0Ow3w1Er7N9UQ5%2bf8C4aZdUI78BHznxfoII%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>

<!-- Mirrored from themextemplates.com/demo/midway/services by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 06:01:15 GMT -->
</html>