		...
		<header class="container site-header">
			...
			<div class="row supheader">
				...
				<div class="social-links">
					<a class="facebook" href="#"  title="Facebook"></a><a class="twitter" href="#" title="Twitter"></a><a class="Login" href="../midway/index.php" title="Logout"></a></div>
					<!-- social links -->
...
<ul class="sub-menu">
	...
	<li id="menu-item-277" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-277"><a href="../admin/report4.php?offset=0class="active"">Comentator</a></li>
 ...
 <thead align=right>
        <th width="144"><label for="tcari"></label>
          <div align="right">
            ...
            &nbsp
             <a href="../Admin/report.php?&offset=0&cari=class="active""><input type="submit" name="button" id="button" value="All Data" class="btn-info btn style12" /></a>
			&nbsp
			<a href="../Admin/pick_up.php"> <input type="button" name="button" id="button" value="Input Data" class="btn-info btn style12" /></a>
...
<?php 
	...
	//$i= 1 :
	$nomor = 1;
	$result = mysql_query("SELECT * FROM pick_up where no_reserv LIKE '$cari'");
	//$nomor=($limit * $_GET['offset'])+1;
	while
	($row = mysql_fetch_array($result)) {
	?>
