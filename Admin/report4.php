...
<?php
 error_reporting(E_ALL ^ E_DEPRECATED);
	...
	$limit = 5;
	$query = new CnnNav($limit,'komentar','*','id_komen');
...
<head>
	...
	<title>Coment Report | TourAceh</title>	
...
<font color="GREEN" face="Kristen ITC" size="4" > >> &nbsp &nbsp Data Comentator &nbsp &nbsp<<</font>
</marquee></strong><br><br>
<form name="form1" method="POST" action="">
<thead align=right>
        <th width="144"><label for="tcari"></label>
          <div align="right">
            <input type="text" name="cari" placeholder="Search... "id="tcari">
            &nbsp &nbsp &nbsp
            <input type="submit" name="button" id="button" value="Search" class="btn-info btn style12"/>
            &nbsp
             <a href="../Admin/report.php"><input type="submit" name="button" id="button" value="All Data" class="btn-info btn style12" /></a>
			&nbsp
			<a href="../Admin/input_komen.php"> <input type="button" name="button" id="button" value="Input Data" class="btn-info btn style12" /></a>
     ...
     <table width="808" height="67" align="center">
		...
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Nama Komentar</strong></b></div></th>
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Email</strong></b></div></th>
        <th bgcolor="#CCCCCC"><div align="center"><b><strong>Komentar</strong></b></div></th>
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Tanggal</strong></b></div></th>
...
<?php 
	...
	$nomor = 1;
	  ...
	  if(isset($_POST['button'])){
		$result=mysql_query("SELECT * FROM komentar where nama LIKE '%".$_POST['cari']."'");
		}else{
...
?>
	<tbody>
	 <tr>
				...
				<td valign="top" class="nowrap"><?php echo $row[4] ?></td>
				<td width="81"><div align="center"><center>
				  <strong><a href="<?php echo "action_delete_komen.php?id_komen=" . $row [0]; ?>" onClick="return confirm ('Apakah anda yakin ingin menghapus data ini ?')"><span class="nowrap">Delete</span></a></strong>
				  </center> 
				  </div> </td>     
         </tr>
		  <?php $nomor++ ;} ?>
