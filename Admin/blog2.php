...
<ul class="sub-menu">
	...
	<li id="menu-item-278" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-278"><a href="../admin/report5.php?offset=0class="active"">Gallery</a></li>
		...
		<?php 
		$result = mysql_query("SELECT id_wisata, nama_wisata, gambar, SUBSTRING(  `keterangan` , 1, 350 ) FROM wisata LIMIT 5 , 4");
	...
	<div class="column fivecol post-featured-image">
		...
		<a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>"><img width="440" height="330" src="Uploads/<?php echo $row[2] ?>" class="attachment-preview wp-post-image" /></a>		</div>
	</div>
	...
	<nav class="pagination">
				...
				<a class="next page-numbers" href="blog/page/2.html"></a>
	</nav>
</div>
...
<article class="post-112 post type-post status-publish format-standard hentry category-guides tag-amet tag-dolor tag-lorem post clearfix">
	...
	<div class="post-content">
		...
		<footer class="post-footer clearfix">
						...
						<div class="post-info">
				<time datetime="2012-11-24">November 24, 2012</time>
			</div>
		</footer>
	</div>
</article>
