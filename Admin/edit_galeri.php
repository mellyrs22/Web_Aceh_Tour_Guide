...
$query = mysql_query("select * from galeri where id_galeri='$id'") or die(mysql_error());
...
<font color="GREEN" face="Kristen ITC" size="4.5" > >> &nbsp &nbsp Input Gallery Photos &nbsp &nbsp<< </font>
</marquee></strong><br><br><br><br>
<form action="../Admin/cek_upload_galeri.php?offset=0" method="POST" enctype="multipart/form-data">	
		<table border = 0 width="472" height="203">
		<input type="hidden" id="id_galeri" name="id_galeri" value="<?php echo $row[0] ?>" placeholder="Id_galeri" />
  <tr>
  ...
  <tr>
    ...
    <th width="161"><div align="left"><strong>
	 <input type="file" name="gambar_makanan" value="<?php echo $row[2]?>"><?php echo $row[2]?><br>
	<input type="hidden" name="gambar_lama" value="<?php echo $row[2]?>"></th>
    </strong></div></th>
  </tr>
