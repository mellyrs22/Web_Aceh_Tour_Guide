...
<font color="GREEN" face="Kristen ITC" size="4" > >> &nbsp &nbsp Edit Tour Destination ! &nbsp &nbsp<<</font>
</marquee></strong><br><br><br>
<form action="../Admin/cek_upload_wisata.php?offset=0" method="POST" enctype="multipart/form-data">	
		<table border = 0 width="472" height="203">
		 <input type="hidden" name="id_wisata" value="<?php echo $row[0] ?>" placeholder="Nama Wisata" />
  <tr>
    <td width="166" class="nowrap"><strong>Nama Wisata</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="nama" name="nama" value="<?php echo $row[1] ?>" placeholder="Nama Wisata" />
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap"><strong>Destinasi</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="Destinasi" name="Destinasi" value="<?php echo $row[2] ?>"  placeholder="Destinasi"/>
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap"><strong>Durasi</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="Durasi"  name="Durasi" value="<?php echo $row[3] ?>" placeholder="Durasi"  />
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap" ><strong>Keterangan</strong></td>
    <th width="161"><div align="left"><strong>
      <textarea name="Keterangan" id="Keterangan" cols=40 rows=5 placeholder="Keterangan"><?php echo $row[5] ?></textarea>
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap" ><strong>Gambar</strong></td>
    <th width="161"><div align="left"><strong>
	<input type="file" name="gambar_makanan" value="<?php echo $row[4]?>"><?php echo $row[4]?><br>
	<input type="hidden" name="gambar_lama" value="<?php echo $row[4]?>"></th>
    </strong></div></th>
  </tr>
    
	  </table>
	  <br>
        <input type="submit" value="Submit"></span></strong></p>
