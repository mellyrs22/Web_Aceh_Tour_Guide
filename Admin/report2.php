...
<?php
 error_reporting(E_ALL ^ E_DEPRECATED);
	...
	$limit = 10;
	$query = new CnnNav($limit,'reserv','*','no_reserv');
		...
		<header class="container site-header">
			...
			<div class="social-links">
				...
				<!-- social links -->
					...
					<div class="menu">
<ul id="menu-main-menu" class="menu"><li id="menu-item-97" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-306"> <a href="../admin/index.php">Home</a>
...
<font color="GREEN" face="Kristen ITC" size="4" > >> &nbsp &nbsp Data Tour &nbsp &nbsp << </font>
</marquee></strong><br><br>
<form name="form1" method="POST" action="">
 <thead align=right>
        <th width="144"><label for="tcari"></label>
          <div align="right">
            <input type="text" name="cari" placeholder="Search by name .. " id="cari">
            &nbsp &nbsp &nbsp
            <input type="submit" name="button" id="button" value="Search" class="btn-info btn style12"/>
            &nbsp
             <a href="../report.php?offset=0class="active""><input type="submit" name="button" id="button" value="All Data" class="btn-info btn style12" /></a>
			&nbsp
			<a href="reserv.php"> <input type="button" name="button" id="button" value="Input Data" class="btn-info btn style12" /></a>
...
<br>
     <table width="808" height="67" align="center">
        <thead><tr><b>
       	   ...
       	   <th  height="30" align="left" bgcolor="#CCCCCC"><div align="center"><strong>No</strong></div></th>
		
       	  <th  bgcolor="#CCCCCC"><div align="center"><strong>Full Name</strong></div></th>
		  <th bgcolor="#CCCCCC"><div align="center"><strong>Email</strong></div></th>
          <th bgcolor="#CCCCCC"><div align="center"><strong>Your Phone</strong></div></th>
		  <th  bgcolor="#CCCCCC"><div align="center"><strong>Adult Number</strong></div></th>
		  <th  bgcolor="#CCCCCC"><div align="center"><strong>Location</strong></div></th>
		  <th  bgcolor="#CCCCCC"><div align="center"><strong>Reserv Date</strong></div></th>
		  <th colspan = "2" align="center" bgcolor="#CCCCCC"><div align="center" class="style7"><strong>Action</strong></div></th>
...
<?php 
	...
	$nomor = 1;
	  ...
	  if(isset($_POST['button'])){
		$result=mysql_query("SELECT * FROM reserv where nama LIKE '%".$_POST['cari']."'");
		}else{
...
?>
	<tbody>
	 <tr class="nowrap">
				...
				<td width="81"><div align="center"><strong><a href="<?php echo "action_delete_reserv.php?no_reserv=" . $row [0]; ?>" onclick = "return confirm ('Apakah anda yakin ingin menghapus data ini ?')"><center>Delete</center></a> </strong></div>
			<td width="48"><div align="center"><strong><a href="<?php echo "edit_reserv.php?no_reserv=" . $row [0];?> class="btn btn-mini"><center>Edit</center></a>
		    </strong></div>
</td>       
	 </tr>
		  <?php $nomor++ ;} ?>
