...
<div class="row">
			...
			<form action="aksi_reserv.php" method="POST">	
		<table border = 0 width="472" height="203">
	

    <tr>
      <td width="154" class="nowrap"><strong> Full Name</strong></td>
      <th width="150"><div align="left"><strong>
      <input type="text" id="full-name" name="name" value="" placeholder="Your Name"  />
      </strong></div></th>
      </tr>
      <tr>
        <td class="nowrap"><strong>Email</strong></td>
        <th width="150"><div align="left"><strong>
		<input type="text" id="email-address" name="email" value="" placeholder="Your Email"  />
        </strong></div></th>
      </tr>
      <tr>
        <td class="nowrap"><strong>Your Phone</strong></td>
        <th width="150" ><div align="left"><strong>
        <input type="text" id="kids-number" name="phone" value="" placeholder="Your Phone"  />
        </strong></div></th>
      </tr>
      <tr>
        <td class="nowrap"><strong>Adult Number</strong></td>
        <th width="150" ><div align="left"><strong>
	<input type="text" id="adults-number" name="adults_number" value="" placeholder="Adults Number"  />
        </strong></div></th>
      </tr>
      <tr>
        <td class="nowrap" ><strong>Locations</strong></td>
        <th width="150"><div align="left"><strong>
         <input type="text" id="locations" name="locations" value="" placeholder="locations"  />
        </strong></div></th>
      </tr>
	        <tr>
        <td class="nowrap" ><strong>Reserv Date</strong></td>
        <th width="150"><div align="left"><strong>
          <input type="date" id="departure-date" name="r_date" value="" placeholder="Reserve Date"  /> 
        </strong></div></th>
      </tr>
