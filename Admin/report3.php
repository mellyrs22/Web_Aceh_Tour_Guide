...
<?php
 error_reporting(E_ALL ^ E_DEPRECATED);
	...
	$limit = 2;
	$query = new CnnNav($limit,'wisata','*','id_wisata');
...
<head>
	...
	<title>Destination Report | TourAceh</title>	
...
<font color="GREEN" face="Kristen ITC" size="4" > >> &nbsp &nbsp Data Tour Destination &nbsp &nbsp<<</font>
</marquee></strong><br><br>
<form name="form1" method="POST" action="">
 <thead align=right>
        <th width="144"><label for="cari"></label>
          <div align="right">
            <input type="text" name="cari" placeholder="Search by destination ... "id="cari">
            &nbsp &nbsp &nbsp
            <input type="submit" name="button" id="button" value="Search" class="btn-info btn style12"/>
            &nbsp
             <a href="../Admin/report3.php?offset=0class="active""><input type="submit" name="button" id="button" value="All Data" class="btn-info btn style12" /></a>
			&nbsp
			<a href="../Admin/input_wisata.php"> <input type="button" name="button" id="button" value="Input Data" class="btn-info btn style12" /></a>
...
<br>
     <table width="808" height="67" align="center">
		...
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Nama Wisata</strong></b></div></th>
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Destination</strong></b></div></th>
        <th bgcolor="#CCCCCC"><div align="center"><b><strong>Durations</strong></b></div></th>
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Image</strong></b></div></th>
		<th  bgcolor="#CCCCCC"><div align="center"><b><strong>Keterangan</strong></b></div></th>
...
<?php 
	...
	$nomor = 1;
	  ...
	  if(isset($_POST['button'])){
		$result=mysql_query("SELECT * FROM wisata where destinasi LIKE '%".$_POST['cari']."'");
		}else{
...
?>
	<tbody>
	 <tr>
				...
				<td valign="top" class="nowrap"><?php echo $row[2] ?></td>
				<td valign="top" class="nowrap"><?php echo $row[3] ?></td>
				<td valign="top" class="nowrap"><img src="../Admin/Uploads/<?php echo $row[4] ?>" alt="" /></td>
				<td valign="top" class="nowrap"><?php echo $row[5] ?></td>
				<td width="81"><div align="center"><center>
				  <strong><a href="<?php echo "action_delete_wisata.php?id_wisata=" . $row [0]; ?>" onClick="return confirm ('Apakah anda yakin ingin menghapus data ini ?')"><span class="nowrap">Delete</span></a></strong>
				  </center> 
				  </div>
			    <td width="48"><div align="center"><center>
				    <strong><a href="edit_wisata.php?id_wisata=<?php echo $row [0] ?>" class=" btn="btn" btn-mini="btn-mini"><span class="nowrap">Edit</span></a></strong>
				    </center> 
			      </div>
		        </td>       
         </tr>
	 ...
	 <center><?php $query->printNav() ?></center></form>
	 <br><br></div></div>
		</section>
		<!-- content -->
