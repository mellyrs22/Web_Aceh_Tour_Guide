...
$query = mysql_query("select * from reserv where no_reserv='$id'") or die(mysql_error());
...
<form action="../Admin/edit_reserv_action.php" method="POST">	
		<table border = 0 width="472" height="203">
	  <input type="hidden" id="no_reserv" name="no_reserv" value="<?php echo $row[0] ?>" placeholder="No Reserv" />
  <tr>
    <td width="166" class="nowrap"><strong>No Reserv</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="no_reserv" name="no_reserv" value="<?php echo $row[0] ?>" placeholder="No Reserv" />
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap"><strong>Name</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="nama" name="name" value="<?php echo $row[1] ?>"  placeholder="Your Name"/>
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap"><strong>Email</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="email"  name="email" value="<?php echo $row[2] ?>" placeholder="Your Email"  />
    </strong></div></th>
  </tr>
   <tr>
    <td class="nowrap"><strong>Phone</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="phone"  name="phone" value="<?php echo $row[3] ?>" placeholder="Your Phone"  />
    </strong></div></th>
  </tr>
   <tr>
    <td class="nowrap"><strong>Adult_Number</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="adult_number"  name="adult_number" value="<?php echo $row[4] ?>" placeholder="Adult_Number"  />
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap" ><strong>Address</strong></td>
    <th width="161"><div align="left"><strong>
      <textarea name="locations" id="locations" cols=40 rows=5 placeholder="Address"><?php echo $row[5] ?></textarea>
    </strong></div></th>
  </tr>
    <tr>
    <td class="nowrap"><strong>Date Reserv</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="date" id="r_date" name="r_date" value="<?php echo $row[6] ?>"/>
    </strong></div></th>
  </tr>
