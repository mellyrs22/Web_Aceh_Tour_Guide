...
var no_reserv = $("#no_reserv").val();
var no_flight = $("#no_flight").val();
var alamat = $("#alamat").val();
var date = $("#date").val();
if (no_reserv == '' || no_flight == '' || alamat == '' || date == '' ) {
alert("Insertion Failed Some Fields are Blank....!!");
} else {
// Returns successful data submission message when the entered information is stored in database.
$.post("aksi_pick_up.php", {
no_reserv1: no_reserv,
no_flight1: no_flight,
alamat1: alamat,
date1: date }, 
function(data) {
alert(data);
...
<font color="GREEN" face="Kristen ITC" size="4.5"> Pick Up Where ?</font>
</marquee></strong><br>
<div class="row">
			<div class="row"><div class="eightcol column"><div class="section-title"><h1>Input Pick up</h1></div>
			<form id="form" name="form"class="formatted-form ajax-form"><p></p>
			<div class="clear"></div><div class="sixcol column ">
			<div class="field-container"><input type="text" id="no_reserv" name="" value="" placeholder="No Reserv"  /></div>
			<div class="clear"></div><div class="field-container"><input type="text" id="no_flight" name="no_flight" value="" placeholder="No Flight"  /></div>
			<div class="clear"></div><div class="field-container"> <textarea id="alamat" name="alamat" placeholder="Address" ></textarea> </div>
			<div class="clear"></div><div class="field-container"><center><input type="date" id="date" name="date" value="" placeholder="Date"  /></center></div>
