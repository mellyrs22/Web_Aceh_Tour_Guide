...
<head>
	...
	<title>Kuta Malaka| TourAceh</title>	
...
<li id="menu-item-121" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121"><a href="../report2.php">Report</a></li>
</ul></div>				</nav>				
				<div class="clear"></div>
				<div class="select-menu select-field">
					<select><option value="http://themextemplates.com/demo/midway/">Home</option><option value="http://themextemplates.com/demo/midway/">Simple Slider</option><option value="http://themextemplates.com/demo/midway/?slider=motion">Motion Slider</option><option value="#">Dropdown</option><option value="#">Item One</option><option value="#">Item Two</option><option value="#">Item Three</option><option value="http://themextemplates.com/demo/midway/services">Services</option><option value="http://themextemplates.com/demo/midway/alltours">Tours</option><option value="http://themextemplates.com/demo/midway/alltours">List Layout</option><option value="http://themextemplates.com/demo/midway/alltours/?layout=grid">Grid Layout</option><option value="#">Dropdown</option><option value="#">Item One</option><option value="#">Item Two</option><option value="#">Item Three</option><option value="http://themextemplates.com/demo/midway/blog">Blog</option><option value="http://themextemplates.com/demo/midway/gallery">Gallery</option><option value="http://themextemplates.com/demo/midway/contact">Contact</option></select>					<span>&nbsp;</span>
				</div>
				<!--/ select menu-->						
			</div>
			<!-- supheader -->
	...
	<div class="sixcol column">		
		<div class="content-slider-container tour-slider-container">
						<div class="content-slider tour-slider">
								<ul>
														<li><img src="../wp-content/uploads/2012/11/kutamalakawaterfall.jpg" alt="" /></li>
	...
	<div class="sixcol column last">
		...
		<ul class="tour-meta">
					<li><div class="colored-icon icon-2"></div><strong>Destination:</strong> <a href="../destinations/thailand.html" rel="tag">Samahani </a></li>
						<li><div class="colored-icon icon-1"><span></span></div><strong>Duration:</strong> 2 hours</li>
											
				</ul>
				<br>
					<p>Air terjun yang sedang anda lihat sekarang bernama air terjun Kuta Malaka berada di Kuta Malaka, Samahani, Aceh Besar. Air terjun ini selain menjadi obyek wisata dan tempat rekreasi, juga digunakan untuk kepentingan masyarakat. 
