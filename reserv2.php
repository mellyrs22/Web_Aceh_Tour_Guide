...
if (name == '' || email == '' || phone == '' || adults_number == '' || locations == '' || r_date == '') {
alert("Insertion Failed Some Fields are Blank....!!");
} else {
// Returns successful data submission message when the entered information is stored in database.
$.post("aksi_reserv.php", {
name1: name,
email1: email,
phone1: phone,
adults_number1: adults_number,
...
<font color="GREEN" face="Kristen ITC" size="4.5" > Reserv Now !</font>
</marquee></strong><br>
<div class="row">
			<div class="row"><div class="eightcol column"><div class="section-title"><h1>Input Reservation</h1></div>
			<form id="form" name="form"class="formatted-form ajax-form"><p></p>
			<div class="clear"></div><div class="sixcol column ">
			<div class="field-container"><input type="text" id="name" name="name" value="" placeholder="Full Name"  /></div>
			<div class="clear"></div><div class="field-container"><input type="text" id="email" name="email" placeholder="Your Email "  /></div>
			<div class="clear"></div><div class="field-container"><input type="text" id="phone" name="phone" placeholder="Your Phone"  /></div>
			<div class="clear"></div><div class="field-container"><input type="text" id="adults_number" name="adults_number" placeholder="Adult Number "  /></div>
			<div class="clear"></div><div class="field-container"><textarea id="locations" name="locations" placeholder="Locations" ></textarea></div>
			<div class="clear"></div><div class="field-container"><center><input type="date" id="r_date" name="r_date"  placeholder="Reserv Date"  /></center></div>

			<br>
			  <input id="submit" type="button" value="Submit"></span></strong></p>
		</div>
