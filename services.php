		...
		<header class="container site-header">
			...
			<div class="row supheader">
				...
				<div class="social-links">
					<a class="facebook" href="#" target="_blank" title="Facebook"></a><a class="twitter" href="http://twitter.com/themextemplates" target="_blank" title="Twitter"></a><a class="login" href="login.php" title="Login"></a>				</div>
				<!-- social links -->
...
<li id="menu-item-306" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-295 current_page_item menu-item-306"> <a href="services.php">Events</a></li>
...
<li id="menu-item-121" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121"><a href="blog.php">Blogs</a></li>
		...
		<footer class="container site-footer">		
			<div class="row">
				...
				<div class="menu"><ul id="menu-footer-menu" class="menu"><li id="menu-item-98" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-98"><a href="index.html">Home</a></li>
<li id="menu-item-307" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-295 current_page_item menu-item-307"><a href="services.html">Events</a></li>
<li id="menu-item-216" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-216"><a href="gallery.html">Gallery</a></li>
<li id="menu-item-99" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-99"><a href="contact.html">Contact</a></li>
</ul></div>			</div>
		</footer>
		<!-- footer -->
