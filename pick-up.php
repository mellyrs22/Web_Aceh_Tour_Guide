		...
		<header class="container site-header">
			...
			<div class="row supheader">
				...
				<div class="social-links">
					<a class="facebook" href="#" target="_blank" title="Facebook"></a><a class="twitter" href="http://twitter.com/themextemplates" target="_blank" title="Twitter"></a><a class="Login" href="login.php" target="_blank" title="Login"></a>				</div>
				<!-- social links -->
...
<div class="row">
			...
			<br>
			<form action="aksi_pick_up.php" method="POST">
