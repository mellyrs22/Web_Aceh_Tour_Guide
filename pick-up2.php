...
<font color="GREEN" face="Kristen ITC" size="4" > Pick-Up Where ?</font>
</marquee></strong><br><br><br><br>
<form action="../midway/aksi_pick_up.php" method="POST">
<table border ="0" width="337" height="203">
  
  <tr>
    <td width="166" class="nowrap"><strong>No Reserv</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="no_reserv" name="no_reserv" value="" placeholder="No Reserv" />
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap"><strong>Date</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="date" name="date" value="" class="date-field" placeholder=" Date"/>
    </strong></div></th>
  </tr>
  <tr>
    <td class="nowrap"><strong>No_Flight</strong></td>
    <th width="161" ><div align="left"><strong>
      <input type="text" id="no_flight"  name="no_flight" value="" placeholder="No Flight"  />
    </strong></div></th>
  </tr>
  <tr>
