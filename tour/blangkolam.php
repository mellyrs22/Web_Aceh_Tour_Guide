...
<head>
	...
	<title>Blang Kolam | TourAceh</title>	
...
<li id="menu-item-121" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121"><a href="../report2.php">Report</a></li>
	...
	<div class="sixcol column">		
		<div class="content-slider-container tour-slider-container">
						<div class="content-slider tour-slider">
								<ul>
														<li><img src="../wp-content/uploads/2012/11/air.jpg" alt="" /></li>
	...
	<div class="sixcol column last">
		<div class="section-title">
			...
			<h1>Air Terjun Blang Kolam</h1>
				</div>
		<ul class="tour-meta">
					<li><div class="colored-icon icon-2"></div><strong>Destination:</strong> <a href="../destinations/thailand.html" rel="tag">Aceh Utara </a></li>
							<li><div class="colored-icon icon-1"><span></span></div><strong>Duration:</strong> 2 Days</li>
											
				</ul>
				<br>
					<p>Salah satu air terjun terindah yang berada di Aceh adalah air terjun blang kolam.  Lokasi air terjun ini adalah di dalam hutan Aceh Utara, tempatnya yang sejuk sangat cocok untuk anda berlibur dengan keluarga. Disini anda juga dapat berendam dibawah air terjun. Sambil berendam anda bisa menikmati pemandangan alam yang sangat indah di hutan ini.
