...
<li id="menu-item-121" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121"><a href="../report2.php">Report</a></li>
	...
	<div class="sixcol column">		
		...
		?>
								...
								<img src="../wp-content/uploads/2012/11/<?php echo $row[4] ?>" alt="" /></li>
	...
	<div class="sixcol column last">
		<div class="section-title">
			<?php 
			$result = mysql_query("SELECT  nama_wisata, destinasi, durasi,  keterangan FROM  `wisata` WHERE id_wisata='$id' ");
			while ($row = mysql_fetch_array($result)) {
			?>		
		...
		<ul class="tour-meta">
						<li><div class="colored-icon icon-2"></div><strong>Destination: &nbsp <?php echo $row[2] ?> </a></li>
						<li><div class="colored-icon icon-1"><span></span></div><strong>Duration:</strong> &nbsp <?php echo $row[2] ?></li>
