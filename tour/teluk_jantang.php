...
<head>
	...
	<title>Hidden Beach | TourAceh</title>	
...
<li id="menu-item-121" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-121"><a href="../report2.php">Report</a></li>
	...
	<div class="sixcol column">		
		<div class="content-slider-container tour-slider-container">
						...
						<?php
					$result = mysql_query ("SELECT b.gambar FROM wisata where b.id_wisata = j.id_wisata");
					
					while ($cols = mysql_fetch_array($result)) {
				?>
								<ul>
														<li><img src="../11/<?php echo $cols [3] ?> alt="" /></li>
	...
	<div class="sixcol column last">
		...
		<ul class="tour-meta">
					<li><div class="colored-icon icon-2"></div><strong>Destination:</strong> <a href="../destinations/thailand.html" rel="tag">Lhoong</a></li>
							<li><div class="colored-icon icon-1"><span></span></div><strong>Duration:</strong> 2 hours</li>
											
				</ul>
				<br>
<p>Aceh merupakan tempat 1001 pantai indah. Salah satu pantai yang tersembunyi dan belum terjamah oleh orang banyak namanya Teluk Jantang, nama yang lagi ngetren sama netizen Aceh “Hidden Beach” katanya.
