		...
		<header class="container site-header">
			...
			<div class="row supheader">
				...
				<div class="social-links">
					<a class="facebook" href="#" target="_blank" title="Facebook"></a><a class="twitter" href="#" target="_blank" title="Twitter"></a><a class="Login" href="login.php" target="_blank" title="Login"></a>				</div>
				<!-- social links -->
...
<div class="row">
			...
			<br>
			  <input id="submit" type="button" value="Submit"></span></strong>
		</div>
